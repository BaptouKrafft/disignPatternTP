...
public class Main {
    public static void main(String[] args) {
        ...
        String res1 = "Album{als=[Photo{auteur='JMP', annee=2018, nom='Aurore Boréale'}, Photo{auteur='JMP', annee=2018, nom='Trek'}, Photo{auteur='SM', annee=2018, nom='Fjord'}, Article{auteur='Pierre', annee=2018, nom='Fosse'}, Article{auteur='John', annee=2018, nom='Boom'}, Article{auteur='Pierre', annee=2018, nom='HI'}, Video{auteur='JMP', annee=2018, nom='caisse'}, Video{auteur='JMP', annee=2018, nom='Bass'}, Video{auteur='JMP', annee=2018, nom='BAM'}]}";
        assert (al.toString().equals(res1)) : "Bug" ;

        al.supprimerVideoFromAuthor("JLA");

        String res2 = "Album{als=[Photo{auteur='JMP', annee=2018, nom='Aurore Boréale'}, Photo{auteur='JMP', annee=2018, nom='Trek'}, Photo{auteur='SM', annee=2018, nom='Fjord'}, Article{auteur='Pierre', annee=2018, nom='Fosse'}, Article{auteur='John', annee=2018, nom='Boom'}, Video{auteur='JMP', annee=2018, nom='caisse'}, Video{auteur='JMP', annee=2018, nom='Bass'}, Video{auteur='JMP', annee=2018, nom='BAM'}]}";
        assert (al.toString().equals(res2)) : "Bug" ;
